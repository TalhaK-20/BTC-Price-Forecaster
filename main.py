...
data = pd.read_csv('data/bitcoin_data_2021.csv')
print(data.head())
...
joblib.dump(open_price_column, 'btc_price_open_model.pkl')
joblib.dump(high, 'btc_price_high_model.pkl')
joblib.dump(low, 'btc_price_low_model.pkl')
joblib.dump(close, 'btc_price_close_model.pkl')


# ------------------------ Loading Models from Files ------------------------

loaded_model_open = joblib.load('btc_price_open_model.pkl')
loaded_model_high = joblib.load('btc_price_high_model.pkl')
loaded_model_low = joblib.load('btc_price_low_model.pkl')
loaded_model_close = joblib.load('btc_price_close_model.pkl')
